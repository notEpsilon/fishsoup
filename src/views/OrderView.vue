<template>
    <div>
        <div class="max-w-7xl mx-auto mt-10 px-4 sm:mt-0 sm:p-4 sm:pt-24">
            ...
            <p class="float-right text-right mt-7 text-gray-500">or just add it to cart: <button @click="addCartElement" class="ml-2 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">Add to Cart</button></p>
        </div>
    </div>
</template>
