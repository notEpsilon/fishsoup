    ...
    <div class="customer-dashboard">
        <header class="bg-white shadow">
            <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                <h1 class="flex items-center justify-between text-3xl font-bold text-gray-900"><span>welcome worker {{ user?.name }}, dashboard</span> <span class="text-base">{{ route.path.substring(1, route.path.length).toLowerCase() }}</span></h1>
            </div>
        </header>
        <main>
